...
public interface OrderItemDAO extends DAO<OrderItem> {
    @Override
    @SqlUpdate("INSERT INTO order_item VALUES ( :orderId, :productId, :price, :discount, :quantity, :createdAt, :updatedAt)")
    @GetGeneratedKeys("id")
    ...
    @SqlBatch("INSERT INTO order_item VALUES (:orderId, :productId, :price, :discount, :quantity, :createdAt, :updatedAt)")
